...
import (
	...
	"github.com/barkerd427/go-vo/client/alerts"
	"github.com/barkerd427/go-vo/client/escalation_policies"
	"github.com/barkerd427/go-vo/client/incidents"
	"github.com/barkerd427/go-vo/client/on_call"
	"github.com/barkerd427/go-vo/client/operations"
	"github.com/barkerd427/go-vo/client/personal_paging_policies"
	"github.com/barkerd427/go-vo/client/personal_paging_policy_values"
	"github.com/barkerd427/go-vo/client/reporting"
	"github.com/barkerd427/go-vo/client/routing_keys"
	"github.com/barkerd427/go-vo/client/teams"
	"github.com/barkerd427/go-vo/client/user_contact_methods"
	"github.com/barkerd427/go-vo/client/user_paging_policies"
	"github.com/barkerd427/go-vo/client/users"
)

// Default go vo HTTP client.
...
// NewHTTPClient creates a new go vo HTTP client.
func NewHTTPClient(formats strfmt.Registry) *GoVo {
	return NewHTTPClientWithConfig(formats, nil)
}

// NewHTTPClientWithConfig creates a new go vo HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *GoVo {
...
// New creates a new go vo client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *GoVo {
	cli := new(GoVo)
...
func (c *GoVo) SetTransport(transport runtime.ClientTransport) {
